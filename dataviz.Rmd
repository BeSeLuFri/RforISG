...
Solutions can be downloaded [here](https://raw.githubusercontent.com/BeSeLuFri/RforISG/master/Files/Course%20Scripts/dataviz_solutions.R) - but try to solve everything without the solutions first!
...
**A crucial learning** from this is that different geometric objects can be put within the same plot. 
