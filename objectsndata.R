...
#' 
#' Download the script here [here](https://raw.githubusercontent.com/BeSeLuFri/RforISG/master/Files/Course%20Scripts/test1.R).
#' 
#' ***
#' 
#' # Objects in R
...
#' 
#' If you already had an object named x before want to change it, you can simply overwrite the old version.
#' 
#' <u>**Assign the value of 10 to the object x**</u>
#' 
## ----Assign the value of 10 to the object x, eval=FALSE------------------
## x

#' 
#' Now you can use "x" in your calculations. 
#' 
#' Example:
## ------------------------------------------------------------------------
b <- 5*x
