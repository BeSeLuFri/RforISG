...
#' 
#' Download the script [here](https://raw.githubusercontent.com/BeSeLuFri/RforISG/master/Files/Course%20Scripts/dataviz_eurostat.R)
#' Download the data [here](xxxxxxxxxxxxxxxxxxxxxx. )
#' 
#' # Info
#' 
#' We practice with the Eurostat data again. 
#' However, to spare us the time of datamanagement, now we already have a prepared daset at hand. 
#' 
#' ***
#' 
#' # Setup
...
#' Read the data ( [eurostat_data.csv](XXXXXX)) and store them as `eurost`.
#' 
