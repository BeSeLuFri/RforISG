...
#' 
#' Solutions can be downloaded [here](https://raw.githubusercontent.com/BeSeLuFri/RforISG/master/Files/Course%20Scripts/soloutions_datamanagement_eurostat.R). But seriously - try to work through this without the solutions, first! You will feel far more at ease with the basics of data manipulation if you write your own code. 
#' 
#' # General
#' 
