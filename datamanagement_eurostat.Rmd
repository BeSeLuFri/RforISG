...
Solutions can be downloaded [here](https://raw.githubusercontent.com/BeSeLuFri/RforISG/master/Files/Course%20Scripts/datamanagement_eurostat.R). But seriously - try to work through this without the solutions, first! You will feel far more at ease with the basics of data manipulation if you write your own code. 

# General

* This page is for you to practice the data management techniques you learned on the last [page](https://beselufri.github.io/RforISG/datamanagement.html). You have to collect, manipulate and merge multiple several variables (from different data sets) by your own. Code wise, there is nothing you. All the operations can be solved with the tidyverse/dplyr grammar from before.
